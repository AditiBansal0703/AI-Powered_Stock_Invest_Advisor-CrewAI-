...
#     @crew
#     def crew(self) -> Crew:
#         """Creates the StockInvestAdvisor crew"""
...
class StockInvestAdvisor():
    ...
    @crew
    def crew(self) -> Crew:
        """Creates and runs the Stock Investment Advisor Crew"""
        return Crew(
            agents=self.agents,   # built automatically from decorated @agent
            tasks=self.tasks,     # built automatically from decorated @task
            process=Process.sequential,
            verbose=True
        )
